...
/** power lut --> an attempt to enable pwm --> failed --> though still interesting
*static const unsigned char power_lut[1][2][9] = {
*	{0x42, 0x47, 0x3E, 0x52, 0x42, 0x3F, 0x3A, 0x37, 0x3F},
*	{0x38, 0x3d, 0x34, 0x48, 0x38, 0x35, 0x30, 0x2d, 0x35},
*};
**/

/** The other power_lut just as above, the values are not really working
...
/**this was part of the pwm attempt----still here in case someone wants to take a try**/
struct mdnie_tuning_info_cabc cabc_tuning_table[CABC_MAX][MODE_MAX][SCENARIO_MAX] = {
	{
		{
			...
			{"NATURAL_UI",		tune_natural_ui,		0},
			{"NATURAL_VIDEO",	tune_natural_video,	LUT_VIDEO},
			{"NATURAL_VIDEO",	tune_natural_video,	LUT_VIDEO},
			{"NATURAL_VIDEO",	tune_natural_video,	LUT_VIDEO},
			{"CAMERA",		NULL,				0},
			{"NATURAL_UI",		tune_natural_ui,		0},
			{"NATURAL_GALLERY",	tune_natural_gallery,		0},
			{"NATURAL_VT",		tune_natural_vt,		0},
		}, {
